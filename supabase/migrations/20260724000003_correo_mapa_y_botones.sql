-- ══════════════════════════════════════════════════════════════════
-- Correo de reserva: abajo se agrega "Cómo llegar" con la sede, su
-- dirección y un botón que abre el mapa. El botón de modificar/cancelar
-- (por WhatsApp) se mantiene. Si la sede no tiene dirección guardada,
