-- Cliente NUEVO (al reservar por la web) debe dar celular, correo y fecha de
-- cumpleaños. El correo ya era obligatorio; ahora también celular y cumpleaños,
-- y se guarda la fecha de cumpleaños. Un cliente que ya existe no se bloquea.
