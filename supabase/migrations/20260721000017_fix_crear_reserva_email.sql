-- Corrige staff_create_reservation: customer_email no admite NULL (es
-- not null default ''). Cuando el correo es opcional y viene vacío, se debe
-- guardar como '' y no como NULL.
