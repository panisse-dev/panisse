...
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA II'), 'pilares', '25', 6, 'rect', 112, 70, 150, 20, 7, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA II'), 'pilares', '24', 5, 'rect', 104, 66, 150, 110, 8, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA II'), 'pilares', '23', 5, 'rect', 104, 66, 150, 200, 9, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA II'), 'pilares', '22', 6, 'rect', 112, 70, 150, 320, 10, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA II'), 'pilares', '21', 6, 'rect', 112, 70, 150, 410, 11, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA II'), 'pilares', '27', 8, 'rect', 132, 82, 470, 20, 12, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA II'), 'pilares', '28', 4, 'rect', 92, 62, 470, 122, 13, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA II'), 'pilares', '29', 4, 'rect', 92, 62, 470, 204, 14, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA II'), 'pilares', '20', 6, 'rect', 112, 70, 330, 410, 15, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA II'), 'pilares', '20A', 6, 'rect', 112, 70, 460, 410, 16, true);

-- ── Salón ROKA I (11 mesas, 56 puestos) ──
insert into public.zones (location_id, name, sort) values ('pilares', 'ROKA I', 1);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA I'), 'pilares', '15', 4, 'rect', 92, 62, 30, 140, 0, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA I'), 'pilares', '14', 4, 'rect', 92, 62, 30, 250, 1, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA I'), 'pilares', '13', 4, 'rect', 92, 62, 30, 360, 2, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA I'), 'pilares', '12', 4, 'rect', 92, 62, 30, 470, 3, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA I'), 'pilares', 'VIP', 12, 'rect', 168, 88, 250, 20, 4, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA I'), 'pilares', '11', 6, 'rect', 112, 70, 240, 470, 5, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA I'), 'pilares', '10', 6, 'rect', 112, 70, 372, 470, 6, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA I'), 'pilares', '16', 4, 'rect', 92, 62, 610, 140, 7, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA I'), 'pilares', '17', 4, 'rect', 92, 62, 610, 250, 8, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA I'), 'pilares', '18', 4, 'rect', 92, 62, 610, 360, 9, true);
insert into public.restaurant_tables (zone_id, location_id, name, seats, shape, width, height, pos_x, pos_y, sort, active)
values ((select id from public.zones where location_id='pilares' and name='ROKA I'), 'pilares', '19', 4, 'rect', 92, 62, 610, 470, 10, true);
